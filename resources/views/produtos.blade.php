           ...
           <div class="modal-header">
            ...
            <div class="modal-body">
             <input type="hidden" id="id" class="form-control">
                ...
                <div class="form-group">
                    <label for="nomeProduto" class="control-label">Preço do Produto</label>
                    <div class="input-group">
                     <input type="number" class="form-control" id="precoProduto" placeholder="Preço do produto">
                    </div>
                </div>
                <div class="form-group">
                    <label for="quantidadeProduto" class="control-label">Qtd do Produto</label>
                    <div class="input-group">
                     <input type="number" class="form-control" id="quantidadeProduto" placeholder="Qtd de produto">
                    </div>
                </div>
                   <div class="form-group">
     ...
     function editar(id){
       $.getJSON('/api/produtos/'+id, function(data){
         $('#dlgProdutos').modal('show');
             ...
             $('#categoriaCategoria').val(data.categoria_id); 
        });
   }
    function remover(id){
        $.ajax({
